...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9b6b8cb41f4a41cbe82a447f9437b392) *)
(*
...
(* # 21 "/Users/matthew/.opam/system/build/oasis.0.3.0/src/plugins/none/NonePlugin.ml" *)
...
let setup_t =
  {
     ...
     package =
       {
          ...
          maintainers = ["Daniel BÃ¼nzli <daniel.buenzli at erratique.ch>"];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "x¾aùhjC\021Zp\150á\128;9æ";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
